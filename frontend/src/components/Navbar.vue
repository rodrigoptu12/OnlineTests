    ...
    <header class="bg-white">
      <nav id="navbar" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto ml-20">
          ...
          <a href="#" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 text-sm font-semibold leading-6 text-gray-900">Exames</a>
          <a href="#" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 text-sm font-semibold leading-6 text-gray-900">Questões</a>
          <a href="#" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4 text-sm font-semibold leading-6 text-gray-900">...</a>
        </div>
        </div>
